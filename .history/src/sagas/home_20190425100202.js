...
function* FetchHome(){
    //监听获取
    const action = yield take('HOMEDATA');
    console.log()
    try{
        console.log("render")
        const home = yield call(axios.get,"https://cnodejs.org/api/v1/topics",{params:{type:action.type}})
        console.log("render",home.data.data)
